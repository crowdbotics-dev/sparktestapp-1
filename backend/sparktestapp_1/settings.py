"""
Django settings for sparktestapp_1 project.
...
ROOT_URLCONF = 'sparktestapp_1.urls'
...
WSGI_APPLICATION = 'sparktestapp_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sparktestapp_1 API",
    "DESCRIPTION": "API documentation for sparktestapp_1 App",
    "VERSION": "v1",
}
